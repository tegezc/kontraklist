...
class _DashboardState extends State<Dashboard> {
  ...
  Future<String> _geturlApi() async {
    String data = await DefaultAssetBundle.of(context).loadString("assets/settings.json");
        ...
        child: Column(
          children: [
            ...
            Wrap(
              ...
              children: [
                CardDashboard(EnumTypeDashboard.hari90),
...
class CardDashboard extends StatefulWidget {
  ...
  CardDashboard(this.enumTypeDashboard, {Key key}) : super(key: key);
